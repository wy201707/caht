<template>
    <div class="TimeInfoComponent-pannel-Test">
        ...
        <!-- <el-form ref="ParticleArgObj" :model="ParticleArgObj" label-width="80px" size="small">
            <el-form-item label="参数类型">
                <el-radio-group v-model="ParticleArgObj.DataType">
                    <el-radio :label="1">风 风速、风向</el-radio>
                    <el-radio :label="2">浪 浪高、浪向</el-radio>
                    <el-radio :label="3">流 流速、流向</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="粒子移动速度" size="mini">
                <el-input-number v-model="ParticleArgObj.interval" :min="1" :max="10" :step="1"></el-input-number>
            </el-form-item>

            <el-form-item>
                <el-button type="primary" @click="onSubmit">播放动画</el-button>
            </el-form-item>
        </el-form> -->
...
import CanvasParticle from './tools/CanvasParticle';
